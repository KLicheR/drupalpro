...
sudo apt-get -yq purge telepathy-indicator folks-common telepathy-logger telepathy-gabble gwibber-service-identica thunderbird telepathy-haze empathy-common gwibber-service-twitter gwibber-service-facebook telepathy-idle empathy telepathy-salut libgwibber2 gwibber-service libfolks-eds25 indicator-datetime thunderbird-globalmenu thunderbird-gnome-support evolution-data-server-common evolution-data-server gwibber libedataserverui-3.0-1 libgwibber-gtk2 nautilus-sendto-empathy telepathy-mission-control-5
#  63mb - Printing
